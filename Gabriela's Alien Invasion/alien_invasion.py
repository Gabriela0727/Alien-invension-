...
class AlienInvasion:
    ...
    def _ship_hit(self):
        """respond to the hsip being hit by an alien."""
    ...
    def _create_fleet(self):
        ...
        #print(number_rows, available_space_y)
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien.rect.y = alien.rect.height * 0 + 1 * alien.rect.height * row_number
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom - 100:
